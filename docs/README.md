...
Covenant is a programming language designed for the age of AI. It uses **contracts** instead of functions, with built-in preconditions, postconditions, intent verification, and enforced namespaces.

## Guides

- **[Getting Started](getting-started.md)** — Install, write your first contract, understand contracts/scope/risk
